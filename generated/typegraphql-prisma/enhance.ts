...
const outputsInfo = {
  ...
  PostGroupBy: ["id", "title", "content", "published", "authorId", "_count", "_min", "_max"],
...
const inputsInfo = {
  ...
  PostOrderByWithAggregationInput: ["id", "title", "content", "published", "authorId", "_count", "_max", "_min"],
  ...
  PostCreateInput: ["id", "title", "content", "published", "author"],
  PostUpdateInput: ["id", "title", "content", "published", "author"],
  PostUpdateManyMutationInput: ["id", "title", "content", "published"],
  ...
  PostCreateWithoutAuthorInput: ["id", "title", "content", "published"],
  ...
  PostUpdateWithoutAuthorInput: ["id", "title", "content", "published"]
};
